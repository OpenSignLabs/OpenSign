...
const getDefaultFormat = (dateFormat) => "MM/dd/yyyy";
  ...
  return (
    <>
      <Rnd
        ...
        bounds="parent"
        className={
          props.pos.key === props.unSignedWidgetId
            ? "signYourselfWithAnimation"
            : "signYourselfBlock"
        }
        style={{
          border:
            props.pos.key === props.unSignedWidgetId
              ? "2px solid rgba(255, 25, 0, 0.984)"
              : "1px solid #007bff",
          borderRadius: "2px",
          textAlign:
            props.pos.type !== "name" &&
