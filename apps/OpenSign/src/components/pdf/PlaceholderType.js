  ...
  switch (type) {
    case "signature":
      return props.pos.SignUrl ? (
        ...
        <div className="text-[8px] w-full h-full text-black flex flex-col justify-center items-center">
    ...
    case "date":
      return props.isSignYourself ||
        ...
        <div
          style={{ fontSize: "7px" }}
          // className="text-[11px] w-full h-full text-black flex flex-col justify-center items-center"
        >
          <span>
