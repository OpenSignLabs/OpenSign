...
async function LoginSSO() {
  ...
  const { COGNITO_LOGIN_REDIRECT_URL, COGNITO_CLIENT_ID, COGNITO_LOGIN_RESPONSE_TYPE, COGNITO_LOGIN_SCOPE, COGNITO_DOMAIN_NAME_URL, COGNITO_CLIENT_SECRET } = process.env;
  try {
